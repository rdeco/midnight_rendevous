    ...
    <div class="row">
        <section class="small-12 columns mainBody">
            ...
            <div class="homeContent hide-for-small-only">
                <h1  class="contentH1 products">All Products</h1>
            ...
            <div class="row">
                <aside class="small-12 columns show-for-small-only">
                    ...
                    <div class="hide-for-large-up show-for-small-only">
                        ...
                        <ul class="productGrid small-block-grid-1 hide-for-medium-only hide-for-large-up" >
                              ...
                              <div class="mobileText"> <?php echo content('30'); ?></div>
